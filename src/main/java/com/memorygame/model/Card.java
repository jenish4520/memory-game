...
public class Card implements Serializable {
    ...
    public Card(int id, String symbol) { this.id = id; this.symbol = symbol; }
    ...
    public boolean isClickable() { return !faceUp && !matched; }

    @Override public boolean equals(Object o) { return this == o || (o instanceof Card c && id == c.id); }
